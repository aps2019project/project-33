...
public class DeckGenerator {
    ...
    String[] heroNames = {"DiveSefid", "Simorgh", "Ezhdaha", "Rakhsh", "Zahhak", "Kaveh", "Arash", "Afsaneh", "Esfandiar",
            "Rostam"};
    String[] spellNames = {"TotalDisarm", "AreaDispel", "Empower", "Fireball", "GodStrength", "HellFire", "LightingBolt",
    ...
    String[] minionNames = {"KamandareFars", "ShamshirzaneFars", "NeyzedareFars", "AsbSavareFars", "PahlevaneFars", "SepahSalareFars"
    ...
    String[] itemNames = {"TajeDanaei", "NamuseSepar", "KamaneDamul", "JunBaw", "TireSeShakh", "PareSimorgh", "Exir"
            , "MajuneRueinTani", "NefrineMarg", "Randomdamage", "TerrorHood", "BladesOfAgility", "KingKiller"
            , "AssassinationDagger", "PoisonousDagger", "ShockHammer", "SoulEater", "GhosleTamid", "ShamshireChini"};

    private int[] heroNumber = {1, 5, 7};
    private int[][] spellNumber = {{1, 7, 10, 11, 12, 18, 20}, {2, 3, 5, 9, 8, 13, 19}, {6, 10, 12, 14, 15, 16, 17}};
    private int[][] minionNumber = {{1, 9, 11, 13, 17, 18, 21, 22, 26, 38, 36, 40}, {2, 3, 5, 8, 12, 15, 19, 23, 27, 30, 33, 39}
            , {6, 7, 10, 14, 16, 20, 24, 25, 28, 29, 31, 34}};
    private int[][] itemNumber = {{1}, {18}, {12}};

    public void deckGenerator() throws IOException {
        for (int i = 0; i < 3; i++) {
